...
add(
  ...
  featureTable([
    ...
    ['Online Class (tile)', 'Faculty dashboard', 'Opens the day\'s classes with a Start online class on each. One tap: it starts the register, takes the class online and puts the teacher in it.'],
...
add(
  ...
  featureTable([
    ...
    ['Resolve', 'Emergency Alerts', 'Closes an alert with a note of what happened, recorded with who resolved it and when, and shown by name to the staff card and to the parent. Also written once.'],
    ['Emergency Alerts (parent)', 'Emergency Alerts', 'Alerts about their own children, with the numbers to call, naming the member of staff who picked each one up and the one who closed it. An unresolved one also appears as a banner on the parent dashboard.'],
...
add(
  ...
  featureTable([
    ...
    ['Expenses', 'Expenses', 'School spending, by category and date, with the receipt attached to the row.'],
...
add(
  ...
  featureTable([
    ...
    ['Mark all read', 'The inbox', 'Clears the count - all of it, however far behind the account has fallen.'],
  ], ['Control', 'Where', 'What it does']),
