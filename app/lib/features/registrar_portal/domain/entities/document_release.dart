...
///
/// Only the two that carry a student's whole record, because those are
/// the ones a school is asked to account for: a receiving school will
/// write back asking when Form 137 was sent and to whom, and a TOR is
/// what a student needs in hand to enrol anywhere else. A certificate of
/// enrolment or a good-moral is printed and forgotten; these are not.
enum SchoolDocument {
