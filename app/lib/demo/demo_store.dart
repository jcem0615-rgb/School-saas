...
class DemoStore {
  ...
  List<Payment> _seedPayments() => [
        ...
        Payment(
          ...
          amount: -1200,
          method: PaymentMethod.cash,
          // The pair recordRefund.ts produces: pay_004 above flips to
          // `refunded` and keeps its positive amount, and this negative
          // row is a `completed` transaction numbered off the receipt it
          // reverses. The two net to nothing, which is the point.
          receiptNumber: 'RC-2024-000166-R',
