...
class AppTheme {
  ...
  /// Deep institutional blue -- reads as "school records system" and keeps
  /// enough contrast against the status colours used for balances,
  /// attendance, and approval states.
  static const _seed = Color(0xFF1B4D8F);
